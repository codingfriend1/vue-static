...
renderMarkdownFolder().then(rendered_files => {
  files = rendered_files
})

const templatePath = folders.template_html_path
if (isProd) {
...
app.use(favicon(isProd ? './dist/favicon-48x48.png': path.join(folders.static_folder, 'favicon-48x48.png')))
